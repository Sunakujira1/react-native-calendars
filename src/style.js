...
export const selectedDayTextColor = textDefaultColor;
export const selectedDayShadeColor = foregroundColor;
export const todayTextColor = textLinkColor;
export const todaySelectedTextColor = textColor;
export const dayTextColor = textDefaultColor;
export const textDisabledColor = '#d9e1e8';
export const confirmedDotColor = textLinkColor;
export const proposedDotColor = textLinkColor;
